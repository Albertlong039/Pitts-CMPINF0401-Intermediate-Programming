...
public class A3
{
	...
	public static void main( String args[] ) throws Exception
	{
		...
		Scanner infile = new Scanner( new File("A3input.txt"));
	...
	static int[] trimArray( int[] arr, int count  )
    {
       ...
       return smaller; // this return will NOT meet A3 requirements, its only here to allow compilation
    }
	...
	{
		int i=0;
		for(i=count-1;i>=0 && newVal < arr[i];){		
			arr[i+1] = arr[i];	
			i--;
		}
		arr[i+1]=newVal;
